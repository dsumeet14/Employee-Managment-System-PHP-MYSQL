    ...
    <form class="mt-8 space-y-6" action="/employeesystem/register.php" method="POST">
      ...
      <div class="rounded-md shadow-sm -space-y-px">
        <div>
          ...
          <input id="EM_id" name="EM_id" type="text" autocomplete="ID" required class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="User Name">
        </div>
        <br>
      <div>
        ...
        <div>
          ...
          <input id="dept" name="dept" type="text" autocomplete="Department" required class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="User Name">
        </div>
        <br>
        <div>
          <label for="Phone" class="sr-only">Phone</label>
          <input id="phn" name="phn" type="text" autocomplete="000000000000" required class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="User Name">
        </div>
        <br>
        <div>
